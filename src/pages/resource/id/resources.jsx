...
import emptyResource from "@/assets/resource/Media.svg";
...
export default function Resources() {
    ...
    const EmptyState = ({ message }) => (
        <Card className="w-full rounded-[20px] border-[1px] border-[#E8D5FF] shadow-md bg-white">
            <div className="flex flex-col items-center justify-center py-12 px-6 gap-4">
                ...
                />
                <p className="font-Nunito text-[18px] text-gray-text text-center">{message}</p>
            </div>
        </Card>
    );
            ...
            <div className="w-full max-w-7xl">
                {activeTab === "ebooks" && (
                    resources.ebooks.length === 0 ? (
                        <EmptyState message="No e-books yet" />
                    ) : (
                ...
                {activeTab === "community" && (
                    resources.community.length === 0 ? (
                        <EmptyState message="No community resources yet" />
                    ) : (
                ...
                {activeTab === "case" && (
                    resources.case.length === 0 ? (
                        <EmptyState message="No case study" />
                    ) : (
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
